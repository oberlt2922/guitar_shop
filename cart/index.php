...
switch ($action) {
    case 'view':
        $inventory_error = $_SESSION['inventoryError'];
        $inventory_error_array = $_SESSION['inventoryErrorArray'];
        $_SESSION['inventoryError'] = FALSE;
        $_SESSION['inventoryErrorArray'] = array();
        $cart = cart_get_items();
        break;
    case 'add':
